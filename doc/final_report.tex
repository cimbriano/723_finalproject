...
\section{ Evaluation }
	...
	\subsection{ Method }
    We used the Speech Accent Archive as our test data set for the distinguisher.
...
%	\bibitem{sads} Elaine Shi, Charalampos Papamanthou \emph{Streaming Authenticated Data Structures}, Date Unknown
	\bibitem{carmel} Carmel Library
	\bibitem{saa}  SAA
	\bibitem{oed} OED
	\bibitem{cmu} CMU Dictionary
	\bibitem{hal} Hal's Project 1 code?
\end{thebibliography}
