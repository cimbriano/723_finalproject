...
\section{ Evaluation }
	...
	\subsection{ Method }
	The Speech Accent Archive, produced by researchers at George Mason University, it a large data set of speakers of various languages speaking a short paragraph along with a phonetic transcription of their speech.
    ...
    We will evaluate our distinguisher using the percentage of speakers that were correctly identified by the distinguisher.
